...
<button class="bg-primary text-background-dark px-8 py-4 rounded-lg font-bold uppercase tracking-widest hover:bg-white transition-all whitespace-nowrap">
    ...
    '''<form class="flex flex-col sm:flex-row gap-3 max-w-md" data-lead-form data-redirect="thank-you.html" action="thank-you.html" method="get">
...
idx_code = idx_code.replace(
    ...
    '''<form id="lead" class="space-y-4" data-lead-form data-redirect="thank-you.html" action="thank-you.html" method="get">'''
)
idx_code = idx_code.replace(
